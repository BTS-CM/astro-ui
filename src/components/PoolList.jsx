                    ...
                    <DialogContent className="sm:max-w-[500px] bg-white">
                        ...
                        </div>
                        {
                            [assetA, assetB].map((asset, index) => {
                                return <div className="grid grid-cols-2 gap-2" key={`assetInternalLinks${index}`}>
                                            <div className="col-span-2">
                                                <h2>{asset.symbol}</h2>
                                            </div>
                                            <a href={`/dex/index.html?market=${asset.symbol}_${asset.symbol === "BTS" ? "HONEST.USD" : "BTS"}`}>
                                                <Button
                                                    variant="outline"
                                                    className="w-full"
                                                >
                                            ...
                                            <a href={`/borrow/index.html?tab=searchOffers&searchTab=borrow&searchText=${asset.symbol ?? ""}`}>
                                                <Button
                                                    variant="outline"
                                                    className="w-full"
                                                >
