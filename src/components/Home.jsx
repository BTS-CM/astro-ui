            ...
            <HoverCard key="ltm">
              ...
              <HoverCardContent className="w-80 text-sm pt-1">
                <ul className="ml-2 list-disc [&>li]:mt-2">
                  ...
                  <li>
                    Lifetime members receive a 80% vesting balance rebate on
                    fees.
                  </li>
                  <li>
                  ...
                  <li>
                    Lifetime members can earn through the referral system.
                  </li>
                </ul>
              </HoverCardContent>
            </HoverCard>
