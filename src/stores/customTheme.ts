...
export const PAGE_ACCENTS: Record<string, AccentTriple> = {
  ...
  settlement: { primary: "#0e7490", secondary: "#06b6d4", tertiary: "#0ea5e9" },
  settlement_bids: { primary: "#0e7490", secondary: "#06b6d4", tertiary: "#0ea5e9" },
...
export const PAGE_SECTIONS: Record<string, NavSection> = {
  ...
  "portfolio-open-orders": "exchanging",
